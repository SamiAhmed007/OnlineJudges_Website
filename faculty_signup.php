...
<script>
  ...
  background: azure;
		...
		<link href="assets/img/codelogo.jpg" rel="icon">
  		<link href="assets/img/codelogo.jpg" rel="apple-touch-icon">
</head>
...
<br>
    ...
    <br>
<br>
<span style = "font-size:25px" class="Subhead"> <b>Registration Login Panel for faculty</b>
<br>
<br>
...
<form name="RegForm" action="insertfaculty.php"	onsubmit="return GFG()" method="post" >
  ...
  /*background:silver;*/
    ...
    border-radius:25px;">
			...
			<br />
			<p>E-mail Address: <input type="email"	size="35" name="fEMail" placeholder="Enter your Vardhaman E-mail"></p>
			<br />
